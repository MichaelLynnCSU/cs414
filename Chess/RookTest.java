...
public class RookTest {
	...
	public void testLegalMoves() throws Exception, IllegalPositionException {
		...
		ArrayList<String> places = new ArrayList<>(Arrays.asList("a2", "a3", "a4","b1","c1","d1")); // this returns based of offset utility
	...
	public void collision() throws Exception, IllegalPositionException {
		...
		b1.placePiece(new Rook(b1,ChessPiece.Color.WHITE),"a5"); // offset applyed in method
		b1.placePiece(new Rook(b1,ChessPiece.Color.BLACK),"d0"); // offset applyed in method
